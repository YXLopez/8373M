...
// leftdrive            motor         1               
// intake               motor         5               
// frontArm             motor_group   12, 13          
// backArm              motor_group   15, 16          
...
void usercontrol(void) {
  ...
  while (1) {
    ...
    if(Controller1.ButtonL1.pressing()) {
      frontArm.spin(vex::directionType::fwd);
    }

    else if(Controller1.ButtonL2.pressing()) {
      frontArm.spin(vex::directionType::rev);
    }
 ...
 if(Controller1.ButtonA.pressing()) {
      backArm.spin(vex::directionType::fwd);
    }

    else if(Controller1.ButtonY.pressing()) {
      backArm.spin(vex::directionType::rev);
    }
